...
import 'package:movies_app/actors/presentation/pages/actors_page.dart';
...
import 'package:movies_app/movies/presentation/views/upcoming_movies_view.dart';
...
const String upcomingMoviesPath = 'upcomingMovies';
const String actorDetailsPath = 'actorDetails/:actorId';
        ...
        routes: [
          GoRoute(
            ...
            routes: [
              ...
              GoRoute(
                name: AppRoutes.upcomingMoviesRoute,
                path: upcomingMoviesPath,
                pageBuilder: (context, state) => const CupertinoPage(
                  child: UpcomingMoviesView(),
                ),
              ),
              GoRoute(
                name: AppRoutes.actorDetailsRoute,
                path: actorDetailsPath,
                pageBuilder: (context, state) => CupertinoPage(
                  child: ActorView(
                    actorId: int.parse(state.params['actorId']!),
                  ),
                ),
              ),
            ],
